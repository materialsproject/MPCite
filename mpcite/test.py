...
config_file = Path("/Users/michaelwu/Desktop/projects/MPCite/files/config.json")
...
doi_record: DOIRecordModel = DOIRecordModel.parse_obj(bld.doi_store.query_one(criteria={bld.doi_store.key: mp_id}))
material: MaterialModel = MaterialModel.parse_obj(
    bld.materials_store.query_one(criteria={bld.materials_store.key: mp_id}))

elink_response_model = ELinkGetResponseModel(osti_id=doi_record.get_osti_id(),
